...
import 'package:flutter_new_test_project/widget/offersListItem.dart';
import 'package:flutter_new_test_project/widget/restaurantListItem.dart';
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              Text(
                                "Chandigarh University Premises (Only)",
                                style: TextStyle(
                                  fontSize: 15,
                  ...
                  Container(
                    child: Column(
                      children: <Widget>[
                        ...
                        restaurantListItem(
                          imageUrl:
                              'https://images.pexels.com/photos/674574/pexels-photo-674574.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
                          name: "Pandit Ji Paranthe Wale",
                          description:
                              "North Indian, American, Snacks, Street Food, Indian, Thai",
                          ratting: 3.5,
                          mins: 30,
                          price: 200,
                        ),
